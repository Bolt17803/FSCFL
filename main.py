...
parser.add_argument("--custom_top_k_clusters", type=int, default=2) # used while weights assigning
...
central_unit = CentralUnit(model_class=model_class,
                           ...
                           custom_warmup_rounds=config["custom_warmup_rounds"],
                           custom_similarity_interval=config["custom_similarity_interval"],
                           custom_similarity_momentum=config["custom_similarity_momentum"],
                           custom_noise_samples=config["custom_noise_samples"],
                           custom_threshold_std_scale=config["custom_threshold_std_scale"],
                           custom_top_k_clusters=config["custom_top_k_clusters"],
                           device=device)
